...
<body>
    ...
    <?php
        ...
        if (isset($_GET['error']) && $_GET['error'] === 'error_borrar_producto') {
            echo "<script>
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                    ...
                    <tbody>
                        ...
                        if ($consultaProductos->num_rows > 0) {
                            ...
                            while ($producto = $consultaProductos->fetch_assoc()) {
                                ...
                                echo "<td>
                                        <a href='crear_producto.php?id={$producto['id_producto']}' class='btn btn-warning btn-sm'>Editar</a>
                                        <button class='btn btn-danger btn-sm' onclick='confirmarEliminacion({$producto['id_producto']})'>Eliminar</button>
                                    </td>";
                                echo "</tr>";
                            }
                        } else {
        ...
        function confirmarEliminacion(idProducto) {
            return Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // Crear un campo oculto para enviar el ID del producto
